...
class RainPointValveEntity(CoordinatorEntity, ValveEntity):
    ...
    def __init__(
        ...
        self._attr_unique_id = f"rainpoint_spenceh14_{hid}_{mid}_{addr}_zone{zone_num}"
    ...
    def _get_configured_duration_seconds(self) -> int:
        ...
        mid = self._sensor_info["mid"]
        addr = self._sensor_info["addr"]
        unique_id = f"rainpoint_spenceh14_{hid}_{mid}_{addr}_zone{self._zone_num}_duration"
